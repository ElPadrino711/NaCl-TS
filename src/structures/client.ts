...
export class NaCl extends djs.Client{
	...
	constructor(){
		super({intents: ['GUILDS', 'GUILD_MESSAGES', 'DIRECT_MESSAGES', 'GUILD_VOICE_STATES'],partials: ['CHANNEL'],allowedMentions: {repliedUser: !1},presence: {status: 'idle',activities: [{name: 'No bitches? 😿',type: 1,url: 'https://twitch.tv/el_padrino_717'}]}})
